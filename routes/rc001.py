...
@rc001_bp.route('/rc001/collections', methods=['GET'])
...
@rc001_bp.route('/rc001/mint/<collection_name>', methods=['GET'])
...
@rc001_bp.route('/rc001/inscriptions/<collection_name>/<address>', methods=['GET'])
...
@rc001_bp.route('/rc001/collection/<collection_name>', methods=['GET'])
...
@rc001_bp.route('/rc001/validate/<inscription_id>', methods=['GET'])
...
@rc001_bp.route('/rc001/mint_hex/<collection_name>', methods=['GET'])
