...
function validateInputs(params) {
  const { sendingAddress, wifPrivateKey, utxos, recipients, fee, changeAddress } = params;
 ...
 */
async function sendDogeTransaction(sendingAddress, wifPrivateKey, utxos, recipients, fee, changeAddress) {
  try {
    // Validate inputs
    ...
    transaction.from(formattedUtxos);
